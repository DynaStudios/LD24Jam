...
namespace DynaStudios.LD24.Game.NonEntities
{
    public class Camera
    {
        ...
        {
            _position = _target.Position.Visual + _offsetDistance;
            // new Vector3(0, 0, 50);
            //_target = new Vector3();
        ...
        private void UpdateViewMatrix(Matrix chasedObjectsWorld)
        {
            ...
            Vector3 targetPosition = Target.Position.Visual;
            ...
            ViewMatrix = Matrix.CreateLookAt(_position, _target.Position.Visual, Vector3.Up);
        }
