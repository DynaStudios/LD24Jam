...
{
    public class MediumPanel : IGuiItem
    {
        ...
        public virtual void Draw(GameScreen gameScreen, GameTime gameTime)
        {
            ...
            {
                PanelBackground = gameScreen.ScreenManager.Game.Content.Load<Texture2D>("Images/UI/middleContainer");
            }
